...
#if defined(CONFIG_MACH_GIO) /* Atheros */
		if (gpio_get_value(BT_PWR) == 0) {
			mdelay(30);
			wlan_setup_clock(0);		
		}
...
#if 0	//ino.baek 2010-08-26 : Changed Gio H/W rev 0x3 -> 0x1	
	// WLAN_RESET_N 
...
#ifdef	CONFIG_MACH_GIO_TELSTRA
MACHINE_START(MSM7X27_SURF, "GT-S5660T Board")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io        = MSM_DEBUG_UART_PHYS,
	.io_pg_offst    = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
