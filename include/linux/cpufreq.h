...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_LILGSMART)
extern struct cpufreq_governor cpufreq_gov_lilgsmart;
#define CPUFREQ_DEFAULT_GOVERNOR 	(&cpufreq_gov_lilgsmart)
