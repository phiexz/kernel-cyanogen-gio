...
// defines
#define DX_MODULE_NAME 			"tassuv"
#define DX_PROCFS_NAME 			"tassuv"
#define DXDBG(x)					
...
// init module
static int __init tassuv_init(void)
{
...
static void __exit tassuv_exit(void)
{
...
module_init(tassuv_init);
module_exit(tassuv_exit);

MODULE_DESCRIPTION("Undervoltage module for Tass");
MODULE_LICENSE("GPL");
